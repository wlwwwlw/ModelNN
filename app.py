...
# Координаты административных центров территорий Нижегородской области.
# Используются для демонстрационной карты, если полигоны OSMnx не подтягиваются.
NN_COORDS = {
...
def inspect_population_file(uploaded_file) -> Tuple[bool, str]:
    ...
    try:
        ...
        try:
            ...
            pass
    return False, "В этот блок нужен файл с населением территорий, например population_NN.xlsx"
...
def inspect_results_file(uploaded_file) -> Tuple[bool, str]:
    ...
    try:
        ...
        try:
            ...
            pass
    return False, "В этот блок нужен файл с инфраструктурными объектами, например results_NN.xlsx"
...
def inspect_distances_file(uploaded_file) -> Tuple[bool, str]:
    ...
    try:
        ...
        try:
            ...
            pass
    return False, "В этот блок нужна матрица дорожных расстояний, например distances_matrix_NN.xlsx"
...
def run_model_from_uploads(population_file, results_file, distances_file, n_trials: int) -> Path:
    ...
    population_path = input_dir / "population_NN.xlsx"
    results_path = input_dir / "results_NN.xlsx"
    distances_path = input_dir / "distances_matrix_NN.xlsx"
